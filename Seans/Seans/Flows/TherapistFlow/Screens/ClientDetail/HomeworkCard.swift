...
struct HomeworkCard: View {
    ...
    private var iconBackgroundColor: Color {
        if response?.isCompleted == true {
            return Color.seansSuccess.opacity(0.15)
        }
        return Color.seansPrimary.opacity(0.15)
    }

    private var iconColor: Color {
        if response?.isCompleted == true {
            return Color.seansSuccess
        }
        return Color.seansPrimary
    }
        ...
        Button(action: onTap) {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: CornerRadius.sm)
                    ...
                    .foregroundStyle(Color.seansPrimary.opacity(0.3))
            )
        }
        .buttonStyle(.plain)
    }
    ...
    private var addIcon: some View {
        ZStack {
            ...
            Image(systemName: "doc.badge.plus")
                .font(.system(size: 14))
                .foregroundStyle(Color.seansPrimary.opacity(0.6))
        }
    }
}
