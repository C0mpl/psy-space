...
struct PaymentSheet: View {
    ...
    private var creditToggleRow: some View {
        HStack {
            ...
            Toggle("Використати кредит", isOn: $useCredit)
                .labelsHidden()
                .tint(Color.seansSuccess)
                .accessibilityLabel("Використати кредит \(userCreditUAH) гривень")
        }
        .padding(Spacing.sm)
        .background(Color.seansSuccess.opacity(0.08))
        ...
        VStack(spacing: Spacing.sm) {
            ...
            HStack {
                ...
                Text("\(amountToPayUAH) \u{20B4}")
                    ...
                    .foregroundStyle(isPaidInFull ? Color.seansSuccess : Color.seansPrimary)
            }
        }
        .padding(Spacing.md)
        .background(Color.seansCardBackground)
    ...
    private var statusIndicator: some View {
        ...
        if payment?.status == .success {
            ...
            .frame(maxWidth: .infinity)
            .padding(Spacing.sm)
            .background(Color.seansSuccess.opacity(0.1))
            .clipShape(.rect(cornerRadius: CornerRadius.md))
        }
        ...
        VStack(spacing: Spacing.sm) {
            if payment == nil {
                if isPaidInFull {
                    ...
                    .buttonStyle(SeansPrimaryButtonStyle())
                } else {
                    Button {
                        initiatePayment()
                    } label: {
                    ...
                    .buttonStyle(SeansPrimaryButtonStyle(isLoading: paymentRepo.isProcessing))
