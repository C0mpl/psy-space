...
struct MoodPicker: View {
    ...
    var body: some View {
        ...
        .animation(PsySpaceAnimation.standard, value: selectedMood)
    }
    ...
    var body: some View {
        Button(action: action) {
            Text(mood.emoji)
                ...
                .background(
                    Circle()
                        .fill(isSelected ? Color.psyspacePrimary.opacity(0.2) : Color.psyspaceCardBackground)
                )
                .overlay(
                    Circle()
                        .stroke(isSelected ? Color.psyspacePrimary : Color.clear, lineWidth: 2)
                )
