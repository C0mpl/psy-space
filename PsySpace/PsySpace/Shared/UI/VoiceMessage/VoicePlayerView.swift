...
struct VoicePlayerView: View {
    ...
    var body: some View {
        ...
        .padding(Spacing.sm)
        .background(Color.psyspaceSecondary.opacity(0.05))
    ...
    private var speedButton: some View {
        Button {
            ...
            Text(currentRateLabel)
                ...
                .foregroundStyle(player.playbackRate == 1.0 ? Color.psyspaceTextSecondary : Color.psyspaceSecondary)
                .frame(width: 36, height: 28)
                .background(Color.psyspaceSecondary.opacity(player.playbackRate == 1.0 ? 0.05 : 0.15))
                .clipShape(.rect(cornerRadius: CornerRadius.sm))
        }
