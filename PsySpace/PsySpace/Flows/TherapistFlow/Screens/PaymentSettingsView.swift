        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    .buttonStyle(PsySpacePrimaryButtonStyle(isLoading: isSaving))
        ...
        Toggle(isOn: $isTestMode) {
            HStack(spacing: Spacing.sm) {
                Image(systemName: "wrench.and.screwdriver.fill")
                    .foregroundStyle(isTestMode ? Color.psyspaceWarning : Color.psyspaceTextSecondary)
                Text("Тестовий режим")
            }
        }
        .tint(Color.psyspaceWarning)
    }
