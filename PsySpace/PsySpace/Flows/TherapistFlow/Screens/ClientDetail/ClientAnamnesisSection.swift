...
struct ClientAnamnesisSection: View {
    ...
    var body: some View {
        ...
        .animation(PsySpaceAnimation.standard, value: isExpanded)
        .onAppear {
    ...
    private var sectionHeader: some View {
        Button {
            withAnimation(PsySpaceAnimation.standard) {
                isExpanded.toggle()
            }
        } label: {
            HStack {
    ...
    private var emptyAnamnesisView: some View {
        Button {
            ...
            HStack(spacing: Spacing.sm) {
                ZStack {
                    Circle()
                        .fill(Color.psyspaceSecondary.opacity(0.1))
            ...
            .overlay(
                RoundedRectangle(cornerRadius: CornerRadius.sm)
                    ...
                    .foregroundStyle(Color.psyspaceSecondary.opacity(0.3))
            )
        }
        .buttonStyle(.plain)
    }
